...
PROJECTS = [
    ...
    },
    {
        ...
        "tools": ["Python", "pandas", "scikit-learn", "Dash", "Plotly"],
    ...
    },
    {
        ...
        "category": "GenAI / RAG",
        "summary": "RAG assistant that answers questions from indexed PDF documents and shows source evidence.",
        "tools": ["Python", "LangChain", "ChromaDB", "Dash", "SumoPod API"],
        "problem": "Important information is often buried inside PDFs, CVs, reports, and other long documents, making manual review slow and repetitive.",
        "approach": "Built a retrieval augmented generation pipeline that loads PDFs, chunks text, stores embeddings in ChromaDB, retrieves relevant passages, and sends grounded context to a GLM model through SumoPod API.",
        "result": "Built a working Dash assistant that can summarize indexed CV documents, answer natural language questions, and display source snippets from the retrieved pages.",
        "business_impact": "Helps users review documents faster by turning unstructured PDFs into searchable, evidence-backed answers.",
        "features": [
            "PDF loading and text chunking",
            "ChromaDB vector search",
            "Fast page lookup for direct page questions",
            "RAG answer generation with source evidence",
            "Dash interface connected to the reusable RAG pipeline",
        ],
        "status": "In Progress",
        "demo_url": "http://127.0.0.1:8052/",
        "repo_url": "https://github.com/mtijan/data-science-portfolio",
    },
]
